...
public class SecurityUtils {
    ...
    public static Long getUserId() {
        try {
            ...
            throw new BusinessException(HttpStatus.UNAUTHORIZED.value(),"获取用户ID异常");
        }
    }
    ...
    public static Long getDeptId() {
        try {
            ...
            throw new BusinessException(HttpStatus.UNAUTHORIZED.value(), "获取部门ID异常");
        }
    }
